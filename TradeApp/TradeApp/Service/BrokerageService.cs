    ...
    public class BrokerageService : ServiceBase
    {
        ...
        private void OpenPosition(OpenPositionData openPositionData)
        {
            ...
            try
            {
                ...
                Orders openingOrder = _orderFactory.CreateOpeningOrder(openPositionData.Direction, KrakenOrderType.stop_loss, openPositionData.EnteringPrice, openPositionData.Volume, openPositionData.CandleStickId, openPositionData.ConfirmationId, validateOnly: openPositionData.ValidateOnly);
                ...
                Orders closingOrder = _orderFactory.CreateStopLossOrder(openingOrder, openPositionData.ExitingPrice, openPositionData.ValidateOnly);
        ...
        private bool CancelOpeningOrder()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Orders currentOpeningOrder = BrokerPosition.OpeningOrder;
        ...
        private bool CancelClosingOrder()
        {
            ...
            try
            {
                ...
                {
                    Orders currentClosingOrder = BrokerPosition.ClosingOrder;
        ...
        private void ShiftPositionLimits(ShiftPositionLimitsData shiftPositionLimitsData)
        {
            ...
            try
            {
                ...
                if (cancelClosingOrderRes)
                {
                    ...
                    Orders newStopLossOrder = _orderFactory.CreateStopLossOrder(BrokerPosition.OpeningOrder, shiftPositionLimitsData.NewLimitPrice, shiftPositionLimitsData.ValidateOnly);
        ...
        private void UpdateOpeningOrder(Orders order)
        {
            //save the order
        ...
        private void UpdateClosingOrder(Orders order)
        {
            //save the order
            var newOrder = _orderRepository.Save(order);
        ...
        private void UpdateEmergencyOrder(Orders order)
        {
        ...
        public void ClosePositionReceived(string message)
        {
            Task task = new Task(() =>
            {
                ...
                {
                    Orders emergencyExitOrder = BrokerPosition.EmergencyExitOrder;
        ...
        private class Position
        {
            ...
            public Orders OpeningOrder
            {
                ...
                set
                {
                    ...
                    if (value != null)
                        _brokerageService.Mediator.NotifyColleagues<Orders>(MediatorMessages.UpdateOrder, openingOrder);
            ...
            public Orders ClosingOrder
            {
                ...
                set
                {
                    closingOrder = value;
                    if (value != null)
                        _brokerageService.Mediator.NotifyColleagues<Orders>(MediatorMessages.UpdateOrder, closingOrder);
            ...
            public Orders EmergencyExitOrder
            {
                ...
                set
                {
                    ...
                    _brokerageService.Mediator.NotifyColleagues<Orders>(MediatorMessages.UpdateEmergencyOrder, emergencyExitOrder);

                    UpdateOngoingContracts(emergencyExitOrder);
                }
            }

            private void UpdateOngoingContracts(Orders order)
            {
